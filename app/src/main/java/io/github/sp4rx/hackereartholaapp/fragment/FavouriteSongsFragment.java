...
public class FavouriteSongsFragment extends Fragment {
    private static final String TAG = FavouriteSongsFragment.class.getSimpleName();
    ...
    public void updateMusicList() {
        ArrayList<MusicListPojo> tempMusicListPojos = MusicCache.getAllFavouriteSongs(context);
        if (tempMusicListPojos != null) {
            ...
            if (noDataMessage != null) {
                noDataMessage.setText(R.string.no_favourite_songs);
    ...
    MusicListAdapter.OnItemClickListener onItemClickListener = new MusicListAdapter.OnItemClickListener() {
        ...
        public void onFavouriteClick(MusicListPojo musicListPojo, boolean isFavourite) {
            musicListPojos.remove(musicListPojo);
            musicListAdapter.notifyDataSetChanged();
            if (musicListPojos.isEmpty()) {
                noDataMessage.setVisibility(View.VISIBLE);
            } else {
                noDataMessage.setVisibility(View.GONE);
            }
